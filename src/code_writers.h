...
// WARNING: Please don't edit this file. It was generated by the Typescript WinMD tool v%
...
%    }
    ...
    static void write_method_semantic(writer& w, MethodSemantics const& method_semantic, MethodDef& method)
    {
        ...
        if (target.type() == HasSemantics::Property)
        {
            ...
            {
                throw_invalid("Invalid semantic: properties can only have a setter and/or getter");
            }
            ...
            {
                throw_invalid("Properties can only have 1 or 2 accessors");
            }
            ...
            if (distance(accessors) == 2)
            {
                ...
                else
                {
                    if (method + 1 == other_method)
                    {
                        if (!other_method_semantic.Semantic().Getter())
                        {
                            throw_invalid("Invalid semantic: properties can only have a setter and/or getter");
                        }
        ...
        else
        {
            ...
            {
                throw_invalid("Invalid semantic: events can only have an add and/or remove");
            }
            ...
            if (distance(accessors) < 1 || 2 < distance(accessors))
            {
                throw_invalid("Events can only have 1 or 2 accessors");
            }
